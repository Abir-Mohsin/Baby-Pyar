...
export default function Contact() {
  const [content, setContent] = useState('এখানে আপনার যোগাযোগ তথ্য লিখুন...');
    ...
    const fetchPolicy = async () => {
      try {
        ...
        if (docSnap.exists()) {
          ...
          if (data && data.data && data.data.contactInfo) {
            setContent(data.data.contactInfo);
          }
        }
      } catch (error: any) {
  ...
  return (
    <div className="py-16 px-4 bg-white min-h-screen text-gray-900">
      <SEO title="Contact Us" url="https://babypyar.com/contact" />
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-black mb-8">যোগাযোগ</h1>
        {loading ? (
